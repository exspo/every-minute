...
SUITES = {"baker", "nurse", "alarm", "bar", "email", "inbox", "meeting",
          ...
          "trash", "overheard", "minute-itself", "dog", "cat",
...
KEEP_PAIRS = {
    tuple(sorted(p)): why for p, why in [
        ...
        ((T(0, 31), T(2, 12)), "convenience-store: the roller grill restocked for no one / the Gatorade-lighter-banana sale"),
        ((T(0, 32), T(21, 47)), "porch: screen-door / citronella-candle"),
        ((T(0, 4), T(2, 33)), "unsent-text: the inventory of what is still open at midnight / drafted, deleted, drafted again"),
        ((T(1, 12), T(2, 48)), "ceil-fan: argument / 2:48. the ceiling fan"),
        ((T(1, 12), T(23, 33)), "ceil-fan: argument / ceiling fan on low"),
        ((T(1, 17), T(22, 40)), "second-wind: the 9:45 definition, energy with nowhere to go / the 10:40 arrival that ruins tomorrow"),
        ...
        ((T(1, 48), T(23, 44)), "grocery-list: the standing list with the thing for the sink / the item gained at 11:44 and lost by the store"),
        ...
        ((T(12, 9), T(13, 0)), "office-fridge: the expired-yogurt inventory / the fork abandoned in somebody's tupperware"),
        ...
        ((T(14, 40), T(15, 11)), "school-bus: the staging lot, forty buses idle / three arguments delivered to three houses"),
        ((T(14, 40), T(16, 11)), "school-bus: the staging lot / the kid asleep against the glass"),
        ...
        ((T(14, 58), T(17, 41)), "pickup-line: the parent surrendering the podcast / the do-not-exit-the-vehicle liturgy"),
        ...
        ((T(2, 31), T(4, 15)), "truck-stop: shower seven called twice, no takers / the diesel-shower-banana receipt"),
        ...
        ((T(20, 31), T(21, 9)), "cereal-bowl: bowls set out tonight as ritual / the teenager's foraging bowl"),
        ...
        ((T(3, 15), T(4, 27)), "refrigerator: the decision followed by silence / the REFRIGERATE AFTER OPENING label, nothing opened"),
        ((T(3, 28), T(4, 52)), "third-shift: the definition, hours the body agrees to work / thinking about the drive home"),
        ...
        ((T(5, 0), T(7, 8)), "coffee-machine: the timer faithful as an unfed dog / the fill-to-the-second-line instructions"),
